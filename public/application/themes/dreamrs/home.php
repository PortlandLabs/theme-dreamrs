    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="about_img">
                    <img src="<?= $view->getThemePath() ?>/img/about.png" alt="">
                </div>
            </div>
                    ...
                    <div class="row align-items-center justify-content-between tab-pane fade show active"
                        ...
                        <div class="col-lg-6 col-sm-12 col-md-6">
                            <div class="portfolio_box">
                                <a href="<?= $view->getThemePath() ?>/img/project-1.png" class="img-gal">
                                    <div class="single_portfolio">
                                        <img class="img-fluid w-100" src="<?= $view->getThemePath() ?>/img/project-1.png" alt="">
                                    </div>
                                </a>
                        ...
                        <div class="col-lg-5 col-md-6">
                            <div class="row">
                                <div class="col-lg-12 col-sm-6 col-md-12 single_portfolio_project">
                                    <div class="portfolio_box">
                                        <a href="<?= $view->getThemePath() ?>/img/project-2.png" class="img-gal">
                                            <div class="single_portfolio">
                                                <img class="img-fluid w-100" src="<?= $view->getThemePath() ?>/img/project-2.png" alt="">
                                            </div>
                                        </a>
                                        <div class="short_info">
                                            <p>new Project</p>
                                ...
                                <div class="col-lg-12 col-sm-6 col-md-12 single_portfolio_project">
                                    <div class="portfolio_box">
                                        <a href="<?= $view->getThemePath() ?>/img/project-3.png" class="img-gal">
                                            <div class="single_portfolio">
                                                <img class="img-fluid w-100" src="<?= $view->getThemePath() ?>/img/project-3.png" alt="">
                                            </div>
                                        </a>
                                        <div class="short_info">
                                            <p>Exclusive Project</p>
                    ...
                    <div class="row align-items-center justify-content-between tab-pane fade" id="Landing" role="tabpanel"
                        ...
                        <div class="col-lg-5 col-md-6">
                            <div class="row">
                                <div class="col-lg-12 col-sm-6 col-md-12 single_portfolio_project">
                                    <div class="portfolio_box">
                                        <a href="<?= $view->getThemePath() ?>/img/project-4.png" class="img-gal">
                                            <div class="single_portfolio">
                                                <img class="img-fluid w-100" src="<?= $view->getThemePath() ?>/img/project-5.png" alt="">
                                            </div>
                                        </a>
                                        <div class="short_info">
                                            <p>new Project</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_service_text ">
                                <img src="<?= $view->getThemePath() ?>/img/icon/service_1.svg" alt="">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_service_text">
                                <img src="<?= $view->getThemePath() ?>/img/icon/service_2.svg" alt="">
                                <h4>house Build</h4>
                                <p>Lorem ipsum dolor sit amet consectetur elit seiusmod tempor incididunt</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_service_text">
                                <img src="<?= $view->getThemePath() ?>/img/icon/service_3.svg" alt="">
                                <h4>Design&
                                    Build</h4>
                                <p>Lorem ipsum dolor sit amet consectetur elit seiusmod tempor incididunt</p>
                            </div>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_service_text">
                                <img src="<?= $view->getThemePath() ?>/img/icon/service_4.svg" alt="">
                                <h4>Design&
                                    Build</h4>
                                <p>Lorem ipsum dolor sit amet consectetur elit seiusmod tempor incididunt</p>
                            </div>
                ...
                <div class="grid">
                    ...
                    <div class="grid-item big_weight">
                        <div class="project_img">
                            <img src="<?= $view->getThemePath() ?>/img/gallery/gallery_1.png" alt="">
                    ...
                    <div class="grid-item big_height">
                        <div class="project_img">
                            <img src="<?= $view->getThemePath() ?>/img/gallery/gallery_4.png" alt="">
                            <div class="project_gallery_hover_text">
                                <p>Home Apartment</p>
                                <h3><a href="apartment.html"> Detached House For Sale</a></h3>
                                <ul>
                    ...
                    <div class="grid-item">
                        <div class="project_img">
                            <img src="<?= $view->getThemePath() ?>/img/gallery/gallery_2.png" alt="">
                            <div class="project_gallery_hover_text">
                                <p>Home Apartment</p>
                                <h3><a href="apartment.html"> Detached House For Sale</a></h3>
                                <ul>
                    ...
                    <div class="grid-item">
                        <div class="project_img">
                            <img src="<?= $view->getThemePath() ?>/img/gallery/gallery_3.png" alt="">
                            <div class="project_gallery_hover_text">
                                <p>Home Apartment</p>
                                <h3><a href="apartment.html"> Detached House For Sale</a></h3>
                                <ul>
            ...
            <div class="col-lg-7">
                <div class="single_blog">
                    <div class="appartment_img">
                        <img src="<?= $view->getThemePath() ?>/img/blog_1.png" alt="">
                    </div>
